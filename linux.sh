...
echo -e "\e[48;5;10m\e[38;5;0m[i]\e[0m Creating terminal command 'bottyclient' (this requires administrator) and 'nbottyclient' (this does not require administrator)"
