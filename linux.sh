echo -e "\e[48;5;10m[i]\e[0m Installing/Updating NodeJS, npm and ffmpeg"
...
echo -e "\e[48;5;10m[i]\e[0m Installing/Updating libraries"
...
echo -e "\e[48;5;10m[i]\e[0m Searching for updates"
git pull https://github.com/tudbut/bottyclient.git>>ilog.txt 2>&1
echo -e "\e[48;5;10m[i]\e[0m All libraries should be installed now"
echo -e "\e[48;5;10m[i]\e[0m Starting!"
node server.js
