...
const style = "<style>body {background-color: #2C2F33; color: #CCCCCC} button {background-color: #99AAB5; color: #FFF; height: 2em; border-radius: 8px; border: 1px initial #2C2F33; cursor: pointer;}</style>"
const b = ""
